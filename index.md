...
### 2. Day 1
*   [2.1. The Ascent Begins](day1)
*   2.2. An Unexpected Encounter
*   2.3. The First Bivouac

### 3. Day 2
*   3.1. Ascending to the Almaty-Alagir Gorge
*   3.2. Pushing for the Summit of Karnizny Peak
*   3.3. The Point of No Return

### 4. Day 3
*   4.1. Surviving the Ice Trap: Monday Morning
*   4.2. Help from Acquaintances
*   4.3. The Long Way Home

### 5. Rehabilitation
*   5.1. A Month in the Hospital
*   5.2. The Doctor's Verdict
*   5.3. Running

---
*Author: Talgat Karakulov*  
*Basement Stack: GitHub Pages + Markdown*
